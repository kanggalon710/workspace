...
export const DIVISIONS: Division[] = [
  {
    ...
    modules: [
      ...
      { label: "Laporan Lapangan", path: "/canvassing/reports", icon: Camera, permission: "canvassing_reports" },
      { label: "Area Insights", path: "/marketing/bisnis", icon: TrendingUp, permission: "marketing_insights" },
  ...
  },
  {
    ...
    modules: [
      ...
      { label: "Pipeline NOC (Kustom)", path: "/pipelines/divisi/noc", icon: Kanban, permission: "pipelines_noc" },
    ],
  },
  {
    ...
    modules: [
      ...
      { label: "JABNET Sahabat", path: "/loyalty", icon: Heart, permission: "loyalty_admin" },
      {
        ...
        children: [
          ...
          { label: "Template Whatsapp", path: "/whatsapp/templates", icon: MessageCircle, permission: "whatsapp_templates" },
          { label: "Phonebook", path: "/whatsapp/phonebook", icon: MessageCircle, permission: "phonebooks" },
          { label: "Broadcast Pelanggan", path: "/whatsapp/broadcast/pelanggan", icon: Megaphone, permission: "whatsapp_broadcast_pelanggan" },
          { label: "Broadcast Reseller", path: "/whatsapp/broadcast/reseller", icon: Megaphone, permission: "whatsapp_broadcast_reseller" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    modules: [
      ...
      { label: "Pipeline HRD (Kustom)", path: "/pipelines/divisi/hrd", icon: Kanban, permission: "pipelines_hrd" },
  ...
  },
  {
    ...
    modules: [
      ...
      { label: "Tim Saya", path: "/teamspace/teams", icon: UsersRound, permission: "teams" },

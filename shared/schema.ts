...
export const ALL_PERMISSIONS = [
  ...
  { key: "map", label: "Peta Jaringan", group: "Utama" },
  { key: "pops", label: "POP", group: "Aset Jaringan" },
  { key: "odcs", label: "ODC", group: "Aset Jaringan" },
  { key: "odps", label: "ODP", group: "Aset Jaringan" },
  { key: "poles", label: "Tiang", group: "Aset Jaringan" },
  { key: "cables", label: "Kabel", group: "Aset Jaringan" },
  { key: "otbs", label: "OTB Manager", group: "Core Management" },
  { key: "bestrays", label: "Bestray", group: "Core Management" },
  { key: "splitters", label: "Splitter", group: "Core Management" },
  { key: "cable_cores", label: "Core Manager", group: "Core Management" },
  { key: "core_connections", label: "Koneksi Core", group: "Core Management" },
  ...
  { key: "splitter_chain", label: "Splitter Chain", group: "Tools" },
  { key: "power_budget", label: "Power Budget", group: "Tools" },
  { key: "export_import", label: "Export / Import", group: "Tools" },
  { key: "customers", label: "Pelanggan", group: "Billing & MikroTik" },
  { key: "packages", label: "Paket Internet", group: "Billing & MikroTik" },
  { key: "sessions", label: "Sesi Aktif PPPoE", group: "Billing & MikroTik" },
  { key: "devices", label: "Perangkat ONT", group: "Billing & MikroTik" },
  { key: "tickets", label: "Work Order", group: "Billing & MikroTik" },
  { key: "collections", label: "Collection Pipeline", group: "Billing & MikroTik" },
  { key: "billing_sync", label: "Billing Sync Worker", group: "Billing & MikroTik" },
  { key: "monitoring", label: "Monitoring", group: "Billing & MikroTik" },
  { key: "routers", label: "Router MikroTik", group: "Billing & MikroTik" },
  { key: "integrations", label: "Integrasi API", group: "Integrasi & Tools" },
  { key: "audit_logs", label: "Log Aktivitas", group: "Integrasi & Tools" },
  { key: "user_management", label: "Manajemen User", group: "Integrasi & Tools" },
  { key: "customer_portal_admin", label: "Admin Portal Pelanggan", group: "Integrasi & Tools" },
  { key: "loyalty_admin", label: "Manajemen Loyalitas Pelanggan", group: "Pelanggan & Billing" },
  ...
  { key: "whatsapp", label: "WhatsApp (Nomor / Template / Broadcast)", group: "Notifikasi" },
  // v4.2.24: Phonebook — custom contact list untuk broadcast
  { key: "phonebooks", label: "Phonebook (Daftar Kontak Custom)", group: "Notifikasi" },
  { key: "resellers", label: "Manajemen Reseller", group: "Pelanggan & Billing" },
